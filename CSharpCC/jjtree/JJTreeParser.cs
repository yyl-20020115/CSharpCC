...
public class JJTreeParser : JJTreeParserConstants
{
    ...
    public void javacc_input(Exception jjte001, Exception jjte000)
    {
        ...
        catch (Exception _jjte000)
        {
            ...
            if (_jjte000 is RuntimeException)
            {
                { if (true) throw (RuntimeException)_jjte000; }
            }
    ...
    {
        try { jj_input_stream = new JavaCharStream(stream,Encoding.GetEncoding(encoding), 1, 1); } catch (Exception e) { throw new RuntimeException(e.Message,e); }
