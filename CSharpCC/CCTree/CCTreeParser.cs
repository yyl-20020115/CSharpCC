...
public class CCTreeParser : CCTreeParserConstants
{
    ...
    public void CSharpCCInput()
    {
        ...
        try
        {
            ...
            try
            {
                ...
                {
                    CCTreeGlobals.NodePackageName = CCTreeOptions.GetNodePackage();
                }
            }
            catch (Exception _jjte001)
            {
                if (jjtc001)
                {
                ...
                if (_jjte001 is ParseException exception1)
                {
                    { if (true) throw exception1; }
                }
                { if (true) throw (Error)_jjte001; }
            }
            finally
            {
                if (jjtc001)
            ...
            catch (Exception jjte002)
            {
                ...
                if (jjte002 is ParseException exception1)
                {
                    { if (true) throw exception1; }
                }
        ...
        catch (Exception _jjte000)
        {
            ...
            if (_jjte000 is ParseException exception)
            {
                { if (true) throw exception; }
            }
            { if (true) throw (Error)_jjte000; }
        }
        finally
        {
            if (jjtc000)
    ...
    public void option_binding()
    {
        ...
        catch (Exception jjte000)
        {
            ...
            if (jjte000 is ParseException exception1)
            {
                { if (true) throw exception1; }
            }
    ...
    public TreeNode expansion_choices(ASTProduction p)
    {
        ...
        catch (Exception jjte000_)
        {
            ...
            if (jjte000_ is ParseException exception)
            {
                { if (true) throw exception; }
            }
            { if (true) throw (Error)jjte000_; }
        }
        finally
        {
            if (jjtc000)
        ...
        switch ((jj_ntk == -1) ? jj_ntk_func() : jj_ntk)
        {
            ...
            case LBRACKET:
                ...
                catch (Exception jjte003)
                {
                    ...
                    if (jjte003 is ParseException exception)
                    {
                        { if (true) throw exception; }
                    }
            ...
            case TRY:
                ...
                catch (Exception jjte004)
                {
                    ...
                    if (jjte004 is ParseException exception)
                    {
                        { if (true) throw exception; }
                    }
            ...
            default:
                ...
                if (jj_2_4(2147483647))
                {
                        ...
                        switch ((jj_ntk == -1) ? jj_ntk_func() : jj_ntk)
                        {
                            ...
                            case IDENTIFIER:
                                ...
                                catch (Exception jjte005)
                                {
                                    ...
                                    if (jjte005 is ParseException exception1)
                                    {
                                        { if (true) throw exception1; }
                                    }
                    ...
                    catch (Exception jjte006)
                    {
                        ...
                        if (jjte006 is ParseException exception1)
                        {
                            { if (true) throw exception1; }
                        }
            ...
            default:
                ...
                else if (jj_2_6(2))
                {
                    ...
                    catch (Exception jjte003)
                    {
                        ...
                        if (jjte003 is ParseException exception1)
                        {
                            { if (true) throw exception1; }
                        }
                        { if (true) throw (Error)jjte003; }
    ...
    public void ClassOrInterfaceDeclaration()
    {
        ...
        if (s.Equals(CCTreeGlobals.ParserName))
        {
            if (t != null)
            {
                CCTreeGlobals.ParserImplements = t;
            }
            else
            {
    ...
    public CCTreeParserTokenManager token_source;
    ...
    private int jj_gen;
    private readonly int[] jj_la1 = new int[191];
    ...
    /** Constructor. */
    public CCTreeParser(TextReader stream)
    {
    ...
    public CCTreeParser(CCTreeParserTokenManager tm)
    {
        token_source = tm;
        token = new Token();
        jj_ntk = -1;
    ...
    /** Reinitialise. */
    public void ReInit(CCTreeParserTokenManager tm)
    {
        token_source = tm;
        token = new Token();
        jj_ntk = -1;
