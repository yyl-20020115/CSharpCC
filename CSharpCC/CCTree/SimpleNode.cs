...
public class SimpleNode : Node
{
    ...
    /** Accept the visitor. **/
    public virtual object jjtAccept(CCTreeParserVisitor visitor, object data) => visitor.Visit(this, data);

    /** Accept the visitor. **/
    public virtual object childrenAccept(CCTreeParserVisitor visitor, object data)
    {
        if (children != null)
        {
