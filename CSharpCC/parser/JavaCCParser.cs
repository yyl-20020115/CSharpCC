...
public class JavaCCParser : JavaCCParserInternals implements JavaCCParserConstants {
  ...
  private boolean isAllowed(Token t)  {
    ...
    */
   static public class ModifierSet
   {
 ...
 ************************************************/
  ...
  final public List<String> StringList() {
  ...
  final public void cppcode_production() {
  ...
  final public void AccessModifier(NormalProduction p) {
          Token t = null;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case PRIVATE:
    case PROTECTED:
  ...
  final public void regexpr_kind(TokenProduction p) {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case _TOKEN:
  ...
  final public void regexpr_spec(TokenProduction p) {
          Container c = new Container();
  ...
  final public void expansion_choices(Container c1) {
  ...
  final public void expansion(Container c1) {
  ...
  final public Lookahead local_lookahead() {
          Lookahead la = new Lookahead();
          la.setExplicit(true);
          Token t = getToken(1);
          la.setLine(t.beginLine);
  ...
  final public void expansion_unit(Container c) {
          String name;
  ...
  final public void regular_expression(Container c) {
          REndOfFile ef;
          String image;
  ...
  final public void complex_regular_expression_choices(Container c1) {
          boolean morethanone = false;
  ...
  final public void complex_regular_expression(Container c1) {
          int count = 0;
  ...
  final public void complex_regular_expression_unit(Container c) {
          String image;
          Token t = getToken(1);
          int r1 = 0, r2 = -1;
  ...
  final public void character_list(Container c1) {
  ...
  final public void character_descriptor(Container c) {
 ...
 */
  final public Token JavaIdentifier() {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case IDENTIFIER:
      jj_consume_token(IDENTIFIER);
      break;
 ...
 */
  ...
  final public void ClassOrInterfaceDeclaration(int modifiers, List tokens) {
  ...
  final public void ExtendsList(boolean isInterface) {
  ...
  final public void ImplementsList(boolean isInterface) {
  ...
  final public void EnumDeclaration(int modifiers) {
  ...
  final public void ClassOrInterfaceBody(boolean isInterface, List tokens) {
          Token first, last;
          if (tokens == null)
            tokens = new ArrayList();
    jj_consume_token(LBRACE);
  ...
  final public void FieldDeclaration(int modifiers) {
    Type();
    VariableDeclarator();
    label_25:
    while (true) {
  ...
  final public void MethodDeclaration(int modifiers) {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case LANGLE:
      TypeParameters();
      break;
  ...
  final public void FormalParameters(List tokens) {
          Token first, last;
          if (tokens == null)
            tokens = new ArrayList();
    jj_consume_token(LPAREN);
 ...
 */
  ...
  final public void TemplateBase() {
    TemplatePack();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 145:
      jj_consume_token(145);
  ...
  final public void TemplatePack() {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case CLASS:
      jj_consume_token(CLASS);
      break;
  ...
  final public void TypeArguments(List tokens) {
  Token first, last;
  if (tokens == null)
         tokens = new ArrayList();
    jj_consume_token(LANGLE);
  ...
  final public void ResultType(List tokens) {
          Token first = getToken(1);
          if (tokens == null)
            tokens = new ArrayList();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  final public void Name(List tokens) {
          if (tokens == null)
            tokens = new ArrayList();
          Token first = getToken(1);
    JavaIdentifier();
 ...
 */
  final public void Expression(List tokens) {
          Token first = getToken(1);
          if (tokens == null)
            tokens = new ArrayList();
...
// this.
  ...
  final public int IntegerLiteral() {
    jj_consume_token(INTEGER_LITERAL);
          try {
  ...
  final public void Arguments(List tokens) {
          Token first, last;
          if (tokens == null)
            tokens = new ArrayList();
    jj_consume_token(LPAREN);
 ...
 */
  ...
  final public void Block(List tokens) {
          Token first, last;
          if (tokens == null)
            tokens = new ArrayList();
    jj_consume_token(LBRACE);
  ...
  final public void ResourceDeclaration() {
    Type();
    VariableDeclaratorId();
    jj_consume_token(ASSIGN);
    Expression(null);
  ...
  final public void CatchParameter() {
  Token t;
    Modifiers();
    Type();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
